      ...
      appBar: AppBar(
        title: Column(
          ...
          children: [
            ...
            Text(eventData['title'] ?? 'Unknown Event',
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Card(
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Host: ${eventData['organizer'] ?? 'N/A'}",
            ...
            // ─── PARTICIPANT STATS ───
            Text("Participant Analytics", style: Theme
                .of(context)
                .textTheme
                .titleLarge),
            Gap(8.h),
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                final accepted = docs
                    ...
                    .toList();
                final attended = accepted
                    .where((d) => (d.data() as Map)['attendance'] == true)
                    .toList();
                ...
                return Column(
                  ...
                  children: [
                    ...
                    // ─── ATTENDEE LOG ───
                    Text("Registered Users Log", style: Theme
                        .of(context)
                        .textTheme
                        .titleLarge),
                    Gap(8.h),
                    if (docs.isEmpty)
                      const Text("No users have registered yet.",
                            ...
                            child: ListTile(
                              leading: CircleAvatar(
                                ...
                                child: Icon(Icons.person,
                                    color: isPresent ? AppColors.success : Colors.grey),
                              ),
                              title: Text(
                              ...
                              isThreeLine: true,
                              trailing: Chip(
                                label: Text(status.toUpperCase(), style: const TextStyle(
                                    fontSize: 10, fontWeight: FontWeight.bold)),
                                backgroundColor: status == 'accepted' ? AppColors.success.withAlpha(
                                    30) : AppColors.warning.withAlpha(30),
                              ),
                            ),
                          );
                        },
            ...
            // ─── FEEDBACK LIST ───
            Text("Event Feedback", style: Theme
                .of(context)
                .textTheme
                .titleLarge),
            Gap(8.h),
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (feedbacks.isEmpty) return const Text(
                    "No feedback received yet.", style: TextStyle(color: AppColors.textSecondary));
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        title: Row(
                          children: [
                            Text(fb['participantName'] ?? 'Anonymous',
                                style: const TextStyle(fontWeight: FontWeight.bold)),
                            const Spacer(),
                            Row(
